...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'honey_project_links'))

        # Adding field 'Link.project'
        db.add_column(u'honey_link', 'project',
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'honey_project_links')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'honey.project'], null=False)),
            ('link', models.ForeignKey(orm[u'honey.link'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'link_id'])

        # Deleting field 'Link.project'
        db.delete_column(u'honey_link', 'project_id')
    ...
    models = {
        ...
        u'honey.link': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Link'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'honey.projectcommit': {
            'Meta': {'ordering': "['-created']", 'unique_together': "(('project', 'chash'),)", 'object_name': 'ProjectCommit'},
