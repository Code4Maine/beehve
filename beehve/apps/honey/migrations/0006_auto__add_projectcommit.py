...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectCommit'
        db.create_table(u'honey_projectcommit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['honey.Project'])),
            ('chash', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'honey', ['ProjectCommit'])


    def backwards(self, orm):
        # Deleting model 'ProjectCommit'
        db.delete_table(u'honey_projectcommit')
    ...
    models = {
        ...
        u'honey.projectcommit': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'ProjectCommit'},
