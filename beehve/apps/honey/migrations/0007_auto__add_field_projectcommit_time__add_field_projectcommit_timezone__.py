...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCommit.time'
        db.add_column(u'honey_projectcommit', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectCommit.timezone'
        db.add_column(u'honey_projectcommit', 'timezone',
                      self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'ProjectCommit', fields ['project', 'chash']
        db.create_unique(u'honey_projectcommit', ['project_id', 'chash'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectCommit', fields ['project', 'chash']
        db.delete_unique(u'honey_projectcommit', ['project_id', 'chash'])

        # Deleting field 'ProjectCommit.time'
        db.delete_column(u'honey_projectcommit', 'time')

        # Deleting field 'ProjectCommit.timezone'
        db.delete_column(u'honey_projectcommit', 'timezone')
    ...
    models = {
        ...
        u'honey.projectcommit': {
            ...
            'timezone': ('django.db.models.fields.IntegerField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'})
        },
        u'honey.technology': {
