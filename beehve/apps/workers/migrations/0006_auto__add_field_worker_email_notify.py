...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.email_notify'
        db.add_column(u'workers_worker', 'email_notify',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.email_notify'
        db.delete_column(u'workers_worker', 'email_notify')
    ...
    models = {
        ...
        u'workers.worker': {
            ...
            'email_notify': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
