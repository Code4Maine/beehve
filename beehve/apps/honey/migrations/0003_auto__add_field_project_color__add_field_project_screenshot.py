...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.color'
        db.add_column(u'honey_project', 'color',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.screenshot'
        db.add_column(u'honey_project', 'screenshot',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.color'
        db.delete_column(u'honey_project', 'color')

        # Deleting field 'Project.screenshot'
        db.delete_column(u'honey_project', 'screenshot')
