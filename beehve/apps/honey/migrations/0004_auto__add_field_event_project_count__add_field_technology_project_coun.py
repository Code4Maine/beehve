...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.project_count'
        db.add_column(u'honey_event', 'project_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Technology.project_count'
        db.add_column(u'honey_technology', 'project_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Topic.project_count'
        db.add_column(u'honey_topic', 'project_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.project_count'
        db.delete_column(u'honey_event', 'project_count')

        # Deleting field 'Technology.project_count'
        db.delete_column(u'honey_technology', 'project_count')

        # Deleting field 'Topic.project_count'
        db.delete_column(u'honey_topic', 'project_count')
