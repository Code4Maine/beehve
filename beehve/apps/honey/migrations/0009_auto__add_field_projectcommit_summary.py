...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCommit.summary'
        db.add_column(u'honey_projectcommit', 'summary',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectCommit.summary'
        db.delete_column(u'honey_projectcommit', 'summary')
