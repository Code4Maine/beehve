...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'honey_project', 'github_url')

        # Adding field 'Project.git_url'
        db.add_column(u'honey_project', 'git_url',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'honey_project', 'github_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Project.git_url'
        db.delete_column(u'honey_project', 'git_url')
