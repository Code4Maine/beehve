...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'workers_worker', 'last_name')

        # Deleting field 'Worker.first_name'
        db.delete_column(u'workers_worker', 'first_name')

        # Adding field 'Worker.name'
        db.add_column(u'workers_worker', 'name',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'workers_worker', 'last_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Worker.first_name'
        db.add_column(u'workers_worker', 'first_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Worker.name'
        db.delete_column(u'workers_worker', 'name')
